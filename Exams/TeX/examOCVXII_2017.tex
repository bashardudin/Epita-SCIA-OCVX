...
\end{center}
  \begin{flushleft}
    ...
    \textit{
      L'évaluation est un travail d'analyse, à faire en groupe
      d'un \emph{maximum de $\bs{\mathit{3}}$ personnes et d'un
        minimum de $\bs{\mathit{2}}$}. Ce travail doit donner lieu à
      un exposé. Ces exposés auront lieu entre le
      \emph{$\bs{\mathit{24}}$ et le $\bs{\mathit{31}}$ janvier}.  \\
